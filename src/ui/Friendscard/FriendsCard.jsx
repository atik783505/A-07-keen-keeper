...
const FriendsCard = ({ friend }) => {
    return (
        <div className='bg-white p-15 rounded-2xl border border-gray-200 shadow-sm transition-all duration-300 hover:-translate-y-2 hover:shadow-xl hover:border-blue-400 cursor-pointer text-center flex flex-col items-center mt-6 space-y-3 w-11/12 sm:w-full'>
